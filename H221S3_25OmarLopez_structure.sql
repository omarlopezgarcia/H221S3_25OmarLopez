...
GO
-------------------------------------------------------------------------------------
select * from asstudent_active;
select * from asstudent_inactive;
select * from pastudent_active;
select * from pastudent_inactive;
select * from asstudentpay_debt;
select * from asstudentpay_cancelled;
select * from pastudentpay_debt;
select * from pastudentpay_cancelled;
