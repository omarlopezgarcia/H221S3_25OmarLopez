		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">PRODUCCIÓN AGRARIA</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item">PRODUCCIÓN AGRARIA</li>
...
<script>
	...
	function fnBtnActualizar() {
		let xhttp = new XMLHttpRequest();
		xhttp.open("GET", "PastudentActualizar", true);
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				let respuesta = xhttp.responseText;
				arreglo = JSON.parse(respuesta);
	...
	function exportToExcel() {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "EstudiantesPA");
        // Guardar el archivo de Excel
        XLSX.writeFile(workbook, "reporteEstudiantesPA.xlsx");
  	}
	...
	function exportToCSV() {
	  ...
	  let filename = "reporteEstudiantesPA.csv";
